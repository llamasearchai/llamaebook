# Contributing to LlamaEbook

Thank you for your interest in contributing to LlamaEbook! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaEbook:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaebook.git
   cd llamaebook
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaebook.git
   ```
...
By contributing to LlamaEbook, you agree that your contributions will be licensed under the project's MIT License.
